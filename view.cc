...
namespace sample {
    ...
    void View::initElements() {
        ...
        focus_center_point_.visible = false;
        focus_center_point_.color = { 0, 255, 0 };
        focus_center_point_.radius = 15;
        focus_center_point_.thickness = 3;
        ...
        frame_.size = { 1280, 720 };
        frame_.buffer = cv::Mat(1080, 1920, CV_8UC3, cv::Scalar(0, 0, 0));

        desc_.resize(4);
        desc_[0].text = "Press ESC to exit program, Press 'C' to start calibration";
        desc_[1].text = "Press 'S' for single-point calibration (center only)";
        desc_[1].color = { 0, 220, 0 };
        desc_[2].text = "Press 'M' for multi-point calibration (5 points: corners + center)";
        desc_[2].color = { 0, 255, 255 };
        desc_[3].text = "Do not resize the window manually after created";
        desc_[3].color = { 0, 0, 220 };
    ...
    void View::drawElements() {
        ...
        drawables::draw_if(focus_center_point_, &background_);
